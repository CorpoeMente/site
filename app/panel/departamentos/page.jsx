import { DepartamentosList, NovoDepartamento } from '../../Components'
                ...
                >
                    <NextAuthProvider>
                        <main className="grid grid-cols-[288px_minmax(0,1fr)] grid-rows-[64px_minmax(0,1fr)] gap-4	p-4 h-screen bg-white dark:bg-black">
                            ...
                            <AdminPanel />
                            <div className="col-span-4 col-span-4 flex flex-col items-start justify-start text-black bg-[#f4f4f4] dark:bg-black p-12 rounded-lg">
                                <NovoDepartamento />
                                <DepartamentosList />
                            </div>
                        </main>
