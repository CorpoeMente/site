  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="bg-white w-[800px] h-[800px] max-w-[90vw] lg:max-w-[80vw] rounded-xl shadow-xl z-40 fixed left-1/2 top-1/2 transform -translate-y-1/2 -translate-x-1/2 z-50 p-8">
